...
const ListaPendientes = () => {
  ...
  const cargarSolicitudes = async () => {
    try {
      ...
      const datosProcesados = Array.isArray(lista)
        ? lista.map((item) => ({
            ...item,
      ...
      accion: async () => {
        try {
          ...
          if (res.success) {
            ...
            setModalAlerta({
              abierto: true,
              mensaje: `❌ ${res.mensaje || "Error al procesar la aprobación"}`,
              tipo: "error",
            });
          }
        } catch (error) {
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (!url) {
                            setModalAlerta({
                              abierto: true,
                              mensaje: "No hay foto del puesto adjunta.",
                              tipo: "info",
                            });
                            return;
                          }
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (!url) {
                            setModalAlerta({
                              abierto: true,
                              mensaje: "No hay foto del carnet adjunta.",
                              tipo: "info",
                            });
                            return;
                          }
