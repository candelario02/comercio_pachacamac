...
router.get('/estadisticas-graficos', verificarAdmin,adminControlador.obtenerEstadisticasGraficos);
router.get('/publico/validar/:dni', adminControlador.validarQRPublico);
